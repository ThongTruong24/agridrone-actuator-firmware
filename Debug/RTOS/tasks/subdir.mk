...
C_SRCS += \
../RTOS/tasks/actuator_task.c \
../RTOS/tasks/can_task.c \
../RTOS/tasks/health_task.c 

OBJS += \
./RTOS/tasks/actuator_task.o \
./RTOS/tasks/can_task.o \
./RTOS/tasks/health_task.o 

C_DEPS += \
./RTOS/tasks/actuator_task.d \
./RTOS/tasks/can_task.d \
./RTOS/tasks/health_task.d 


# Each subdirectory must supply rules for building sources it contributes
RTOS/tasks/%.o RTOS/tasks/%.su RTOS/tasks/%.cyclo: ../RTOS/tasks/%.c RTOS/tasks/subdir.mk
...
clean: clean-RTOS-2f-tasks

clean-RTOS-2f-tasks:
	-$(RM) ./RTOS/tasks/actuator_task.cyclo ./RTOS/tasks/actuator_task.d ./RTOS/tasks/actuator_task.o ./RTOS/tasks/actuator_task.su ./RTOS/tasks/can_task.cyclo ./RTOS/tasks/can_task.d ./RTOS/tasks/can_task.o ./RTOS/tasks/can_task.su ./RTOS/tasks/health_task.cyclo ./RTOS/tasks/health_task.d ./RTOS/tasks/health_task.o ./RTOS/tasks/health_task.su

.PHONY: clean-RTOS-2f-tasks
