...
C_SRCS += \
../Services/command/command_service.c 

OBJS += \
./Services/command/command_service.o 

C_DEPS += \
./Services/command/command_service.d 


# Each subdirectory must supply rules for building sources it contributes
Services/command/%.o Services/command/%.su Services/command/%.cyclo: ../Services/command/%.c Services/command/subdir.mk
...
clean: clean-Services-2f-command

clean-Services-2f-command:
	-$(RM) ./Services/command/command_service.cyclo ./Services/command/command_service.d ./Services/command/command_service.o ./Services/command/command_service.su

.PHONY: clean-Services-2f-command
